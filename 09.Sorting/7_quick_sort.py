...
def test_quick_sort():
    ...
    print("sorted(seq):", sorted(seq))
    print("quick_sort_cache(seq):", quick_sort_cache(seq))
    print("quick_sort_cache_devided(seq):", quick_sort_cache_devided(seq))
    print("quick_sort(seq, 0, len(seq)-1):", quick_sort(seq, 0, len(seq)-1))
